            ...
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                ...
                <tbody>
                    ...
                    $query = "SELECT prestamos.Id_prestamo,personas.Nombre,prestamos.Cantidad,prestamos.Identificacion,
                                ...
                                prestamos.Id_prestamo=detalle.Id_prestamo AND personas.Activo=1 AND libros.Activo=1 AND prestamos.Fecha_devolucion<NOW() AND prestamos.Estatus='Pendiente' ORDER BY Id_prestamo";
