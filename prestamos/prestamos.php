        ...
        <div class="form-row container">
            <div class="col-md-6 col-lg-5">
                <div class="input-group">
                    <input type="search" name="dato" placeholder="Nombre de la persona"
            ...
            <div class="col-md-6 col-lg-6">
                <div class=" d-flex justify-content-end">
                    <a class="btn boton_nuevo" href="registrar_prestamos.php"><i class="p-2 icofont-plus">Nuevo</i></a>
                </div>
            </div>
        </div>
        <br>
                ...
                <tbody>
                    ...
                    if (isset($_POST['buscar']) && $_POST['dato'] != '') {
                        ...
                        $query = "SELECT prestamos.Id_prestamo,personas.Nombre,prestamos.Cantidad,prestamos.Identificacion,
                                ...
                                prestamos.Estatus FROM libros,prestamos,detalle,personas WHERE
                                prestamos.Id_persona=personas.Id_persona AND libros.Id_libro=detalle.Id_libro AND
                                prestamos.Id_prestamo=detalle.Id_prestamo AND personas.Activo=1 AND libros.Activo=1 ORDER BY Id_prestamo";
                    }
                    ...
                    while ($fila = $resultado->fetch_assoc() and $fila1 = $resultado1->fetch_assoc()) {
                        ...
                        <tr class='text-center'>
                            ...
                            <td><a class="bg-primary py-1 rounded-lg"
                                    href="modificar_prestamos.php?id=<?php echo $fila['Id_prestamo'] ?>"><span
