    ...
    <form class="p-4 needs-validation" action="registrar_usuarios.php" method="POST" novalidate>
      ...
      <div class="form-row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
          ...
          <input type="text" class="form-control" id="validationCustom02" required name="usuario" placeholder="Usuario"
            autocomplete="off" pattern="[a-zA-Z0-9]+" maxlength="16">
          <div class="valid-feedback">
            Correcto!
          </div>
          <div class="invalid-feedback">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
          ...
          <input type="password" class="form-control" id="validationCustom03" required name="pass"
            placeholder="Contraseña" minlength="5" maxlength="16">
          <div class="valid-feedback">
            Correcto!
          </div>
          <div class="invalid-feedback">
