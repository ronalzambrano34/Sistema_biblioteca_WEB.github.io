...
<div class="container">
    ...
    <div class="bg-white rounded-lg formulario">
        ...
        ?>
        <form class="p-4 needs-validation" action="realizar_edicion.php?id=<?php echo $fila['Id_puesto'] ?>"
            method="POST" novalidate>
            <center><label class="mt-2" for="">
                    <h4>ACTUALIZAR PUESTOS</h4>
                </label></center>
            <div class="form-row">
                <div class="cpl-md-12 col-lg-6 mb-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" required name="puesto"
                        placeholder="Puesto" value="<?php echo $fila['Descripcion'] ?>"
